...
**Ajouter une ressource.** La [liste de ressources]({{ site.repository | prepend: "https://github.com/" }}) recense blogs, livres, podcasts, librairies. Si vous connaissez quelque chose qui manque, surtout en français, proposez-le.

**Proposer un sujet.** Vous butez sur quelque chose qu'aucun article francophone n'explique ? Dites-le dans une [issue]({{ site.repository | prepend: "https://github.com/" }}/issues). C'est déjà une contribution : ça indique ce qui manque.

**Écrire un article.** C'est la contribution la plus précieuse, et c'est plus simple qu'il n'y paraît — la marche à suivre est détaillée dans le [guide de contribution]({{ site.repository | prepend: "https://github.com/" }}/blob/main/CONTRIBUTING.md). Votre nom apparaît sur l'article.
